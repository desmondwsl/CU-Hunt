  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={{ gap: 14, paddingBottom: 40 }}>
        ...
        <Card>
          <Text style={styles.h}>陣地擁有者</Text>
        ...
        <Card>
          <Text style={styles.h}>匯出紀錄</Text>
          <Button label="產生 Captures + Items CSV" onPress={exportCsv} />
          {!!exportText && (
            <Text selectable style={{ color: Colors.textMuted, marginTop: 10, fontSize: 11 }}>
              {exportText}
            </Text>
          )}
        </Card>
